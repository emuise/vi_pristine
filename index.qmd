...
```{r}
#| label: nn-map
#| fig-cap: Map of the calculated nearest neighbour distance for our expanded coarsened exact matching procedure. All distances above 2 were not included in our analysis.
```
