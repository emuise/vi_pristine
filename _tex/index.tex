...
\hypersetup{
  pdftitle={Cumulative and individual impacts of the human footprint on similarity to reference high ecological integrity reference states.},
...
states, Remote sensing, Ecosystem structure, Ecosystem function},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\includegraphics[width=6in,height=\textheight,keepaspectratio]{strathcona/figures/study_area.png}
...
\includegraphics[width=5.25in,height=\textheight,keepaspectratio]{figures/flow.drawio.png}
...
\includegraphics[width=12in,height=\textheight,keepaspectratio]{strathcona/figures/mahal_boxplot_sig.png}
